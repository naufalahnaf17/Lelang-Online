...
import 'package:lelangonline/screen/admin/edit_data_admin.dart';
...
class _MainAdminState extends State<MainAdmin> {
  ...
  Future<void> _tambahPetugas() async {
    Navigator.pushReplacementNamed(context, '/admin-tambah-petugas');
  }
